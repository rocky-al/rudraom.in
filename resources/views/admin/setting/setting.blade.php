...
<div class="card mt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div class="col-md-12">
           <h6 class="border-top  pt-3">Android System Setting</h6><br>
                <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('App Version')}}*</label>
                    <input type="text" name="app_version" class="form-control" placeholder="Enter app version" value="{{isset($array['app_version']) ? $array['app_version'] : ''}}" required>
                </div>


                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Update On App')}}*</label>
                   <select  class="form-control" name="update_on_app">
                            <option value="0" {{ (isset($array['update_on_app']) && $array['update_on_app'] == "0" ? 'selected' :'') }} >No</option>
                            <option value="1" {{ (isset($array['update_on_app']) && $array['update_on_app'] == "1" ? 'selected' :'') }}  >Yes</option>
                           </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Is maintenance')}}*</label>
                   <select  class="form-control" name="is_maintenance">
                            <option value="0" {{ (isset($array['is_maintenance']) && $array['is_maintenance'] == "0" ? 'selected' :'') }}  >No</option>
                            <option value="1" {{ (isset($array['is_maintenance']) && $array['is_maintenance'] == "1" ? 'selected' :'') }}  >Yes</option>
                           </select>
                </div>
         </div>
      </div>
             ...
             <div class="col-md-12">
           <h6 class="border-top  pt-3">Ios System Setting</h6><br>
                <div class="row">
                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('App Version')}}*</label>
                    <input type="text" name="ios_app_version" class="form-control" placeholder="Enter app version" value="{{isset($array['ios_app_version']) ? $array['ios_app_version'] : ''}}" required>
                </div>


                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Update On App')}}*</label>
                   <select  class="form-control" name="ios_update_on_app">
                            <option value="0" {{ (isset($array['ios_update_on_app']) && $array['ios_update_on_app'] == "0" ? 'selected' :'') }} >No</option>
                            <option value="1" {{ (isset($array['ios_update_on_app']) && $array['ios_update_on_app'] == "1" ? 'selected' :'') }}  >Yes</option>
                           </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Is maintenance')}}*</label>
                   <select  class="form-control" name="ios_is_maintenance">
                            <option value="0" {{ (isset($array['ios_is_maintenance']) && $array['ios_is_maintenance'] == "0" ? 'selected' :'') }}  >No</option>
                            <option value="1" {{ (isset($array['ios_is_maintenance']) && $array['ios_is_maintenance'] == "1" ? 'selected' :'') }}  >Yes</option>
                           </select>
                </div>
         </div>
      </div>
