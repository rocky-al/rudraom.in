...
{{ Form::open(['url' => route('city.manage'), 'class' => 'form_submit_user', 'method'=>'post', 'files' => 'yes']) }}
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <select class="form-control" name="country_id" >
                                ...
                                <option value="{{$countries->id}}" {{$countries->id=='239' ? 'selected':''}}>{{$countries->name}}</option>
                                  @endforeach
                    </select>
                </div>
                @else
                    ...
                    <select class="form-control" name="country_id" >
                                 @foreach($country as $countries)
                                <option value="{{$countries->id}}" {{$data->country_id==$countries->id ? 'selected':''}}>{{$countries->name}}</option>
                                  @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('City Name')}}*</label>
                 ...
                 <div class="col-md-12 mb-3">
                  ...
                  {!! Form::select('status', array('0' => 'Inactive', '1' => 'Active'), $data->status ?? '1',['class' =>'form-control status']); !!}
                </div>
