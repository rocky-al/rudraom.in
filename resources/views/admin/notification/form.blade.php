...
<div class="card">
 ...
 <div class="col-md-12 mb-3">
    <h6  class="form-label">{{__('Send To')}}</h6>
</div>    
    <div class="col-md-12 mb-3">
                    <div class="d-flex align-items-center customBtn">  
                     <div class="d-flex align-items-center">   
                        <label  class="form-label mb-0">{{__('Select User')}}</label>
                        <input class="ms-2" name ="chkall" id="select_usr" type="radio" value="off"  checked>
                     </div>

                    <div class="d-flex align-items-center ms-5">
                        <label class="form-label mb-0">{{__('All User')}}</label>
                        <input class="ms-2" name ="chkall" id="chkall" type="radio"  value="on"  > 
                    </div>
                </div>
     </div>        
