             ...
             <form id="register_form" class="form-border" method="post">
                               ...
                               <div class="row">
                                <div class="form-group col-md-6" >
                                 ...
                                 <div class="form-group col-md-6">
                                   <label >Business Street Address & Number</label>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <h5>{{ date('M d Y ', strtotime($busns_detail->registration_date))}}</h5>
                    ...
                    <?php } else { ?>
                        ...
                        <?php     }   ?>
                                ...
                                <div class="form-group col-md-6">
                                   <label >Business City,State & Zip</label>
                               <h5>{{$busns_detail->location}}</h5>
                                </div>

                                  <div class="form-group col-md-12">
                                   <label >Business Description</label>
                                   <h5>{{$busns_detail->description}}</h5>
                                </div>
