...
<button type="button" class="close clear_val" data-dismiss="modal" aria-label="Close">
...
<button type="button" class="btn btn-secondary clear_val" data-dismiss="modal">Cancel</button>
...
@endif
                          ...
                          <div class="mx-auto sign_up" style="display:none;">
                            ...
                            @endif
                                 ...
                                 <div class="form-group col-md-6">
                                   <label >Business Street Address & Number <span class="text-danger">*</span></label>
                                  <input name="address" id="address1" type="text" class="form-control border-2"  placeholder="Business Street Address & Number" onfocus="Address2initialize()"  required>
                                </div>

                                 <div class="form-group col-md-6">
                                   <label >Business City, State & Zip<span class="text-danger">*</span></label>
                               <!--    <input name="location" type="text" class="form-control border-2"  placeholder="Business location" required> -->
                                           <input placeholder="Business City, State & Zip" class="form-control pac-target-input valid" name="address2" id="address2"type="text" autocomplete="off" aria-required="true" aria-invalid="false" required>
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6" >
                                  ...
                                  <input name="profife_pic" id="profife_pic" type="file" class="form-control border-2 image"  placeholder="Business profile image"  accept="image/png, image/jpg, image/jpeg"  onchange="pressed()" required>
                                ...
                                <small style="position: relative;top: -5px; font-size:12px;"> &nbsp;<i>Note: For batter image view in the mobile app please upload in the 16 * 9 ratio (for example: 1080*600)</i></small>
                                 ...
                                 <input name="crop_img" type="hidden" id="crop_img" class="form-control border-2 reg_date">
                                ...
                                <div class="form-group col-md-12">
                                  ...
                                  <input style="width: 14px;height: 21px; position: absolute;" class="form-control border-2"  type="checkbox" id="disclaimer" name="disclaimer" value="1" required>
                                  <label for="disclaimer" style="margin-left: 18px;">By registering your business on this application, you agree you are responsible for correctly reporting and remitting any and all federal, state, local, and/or otherwise required tax obligations to the Internal Revenue Service which arise as a result of conducting business on this application.</label>
