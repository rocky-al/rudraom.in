...
$('body').on('click', '#editCompany', function (event) {
    ...
    $.get('order/' + id + '/edit', function (data) {
            ...
            if(data.data.order_status==1){
                  $(".status").append("<option value='2'>Shipped</option><option value='4'>Cancelled</option>");
              }
           ...
           /*if(data.data.order_status==2){
            ...
            if(data.data.order_status==2){
                  $(".status").append("<option value='3'>Delivered</option><option value='4'>Cancelled</option>");
              }
