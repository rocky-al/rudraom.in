            ...
            <div class="row">
               ...
               <div class="col-md-6 mb-3">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  {!! Form::select('status', array('0' => 'Pending', '1' => 'Approved','2' => 'Rejected'), $data->status,['class' =>'form-control status']); !!}
                </div>

                 <div class="col-md-12 mb-3 reason" style="display:none;">
                    <label for="nameBackdrop" class="form-label">{{__('Reason')}}*</label>
                   {!! Form::textarea('reason',$data->reject_reason,['class'=>'form-control ', 'rows' => 2, 'cols' => 40]) !!}
                </div>
