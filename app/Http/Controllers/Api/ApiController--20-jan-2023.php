    ...
    public function businessDetails(Request $request)
       {
          ...
          $item_image = url('uploads/item_image_medium/');
    ...
    public function addReview(Request $request)
    {
     ...
     public function deleteCard(Request $request)
     {
        ...
        if ($validator->fails()) {
         ...
         $check_data = Cards::select('id')->where('id', $request->card_id)->count();  
     ...
     public function orderDetails(Request $request)
     {
        ...
        if ($validator->fails()) {
         ...
         if($check_data > 0){  
            ...
            $itemval = Order::select('orders.id','orders.item_name','address','shipping_id','item_id','item_description','orders.item_price','orders.quantity','shipping_charges','order_status','reject_reason','orders.created_at','order_shipped_date','order_delivered_date','order_cancel_date','order_confirmed_date')     
            ->leftJoin('business_items', function($join) {
                $join->on('business_items.id', '=', 'orders.item_id');
            })        
