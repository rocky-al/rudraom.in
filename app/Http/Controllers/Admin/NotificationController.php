    ...
    {   
       ...
       if($request->chkall=="on"){
        ...
        foreach ($data as  $value) {
          ...
          send_notification_FCM($request->title,$request->message,$value->fcm_token, $redirection = "");
        ...
        $request->validate([
            ...
            foreach ($request->user as  $value) {
                ...
                $user_data = User::select('*')
                        ...
                        ->where('is_delete', '=', '0')
                        ->first();
               // print_r($user_data);dd();

                send_notification_FCM($request->title,$request->message,$user_data->fcm_token, $redirection = "");
